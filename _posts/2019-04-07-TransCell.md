...
其中trigonal三方晶系有两种布拉伐格子的取法，一种是ibrav=5，菱方（rhombohedral）的原胞，另一种是ibrav=4，六方（hexgonal）的晶胞，其中，六方体积是菱方的三倍，所以，在计算能带时应该选菱方。这里的菱方和六方是指晶体的格点系统lattice system，而非晶系，格点系统是按照布拉伐格子分类的，晶系是按照晶体点群分类的。
