...
第三，确定平板和真空的厚度，当然要考虑两个表面之间的作用，为了模拟固体的性质，厚度不能过小，真空至少需要10A到20A。有的文献描述平板厚度时，提到了**层**的概念，层并没有无争议的定义，有时，材料在垂直晶面方向有周期性，那么层可能是周期的个数，而另一些材料有若干层原子为一组，组与组之间可以明显划分开，这里的组就是层，还有的材料，在垂直晶面方向杂乱无章，一个原子就是一层。
