...
首先优化晶格常数，用pw.x进行一次vc-relax计算（晶格常数实验值5.715Å，计算值5.585Å）。GGA计算出的极化往往偏大，极化偏大对介电常数影响较大$\epsilon=1+\frac{4\pi P}{D-4\pi P}$，这里GaAs按照文献中的做法使用了LDA模守恒赝势，赝势文件见[Ga](../../../../../img/Ga.SG15.LDA.UPF)，[As](../../../../../img/As.SG15.LDA.UPF)。
