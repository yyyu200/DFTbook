...
```
     0        1.88972613      1.00000000      1.00000000      0.00000000      0.00000000      0.00000000
...
4.8681
```
其中，最后一行4.8681是移动平均的窗口长度,设置为驰豫后slab中间部分的周期单元长度，单位是Bohr。输出avg.dat见[这里](https://yyyu200.github.io/DFTbook/img/avg.dat)，包括三列，第一列是z方向格点，第二列是势能在xy面内的平均，第三列是z方向移动平均。通过进一步拟合，得到slab中间势能为-0.007Ry，真空势能为0.7044Ry。
