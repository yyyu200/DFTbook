...
### 2.2 建立slab模型并做结构驰豫
建立slab模型的一般方法见[这里](../../07/TransCell/#平板slab模型的建立)。建立slab模型使用前一节得到的理论晶格常数，先对原胞做变换$$P_{1}$$得到晶胞，再做变换$$P_{2}$$得到(110)方向长度为11个原子的超胞，最后加上20Å的真空，得到slab模型，其中
