...
## 4. 声子谱的计算
计算GaAs的声子谱。
（1）优化晶格常数，用pw.x进行一次vc-relax计算。GGA计算出的极化偏大，这里GaAs按照文献中的做法使用了LDA模守恒赝势，赝势文件见[Ga](../../../../../img/Ga.SG15.LDA.UPF)，[As](../../../../../img/As.SG15.LDA.UPF)。
...
在输出ph.out中可以找到高频介电常数$\epsilon_{\infty}$
```
          Dielectric constant in cartesian axis 

          (      13.578582391       0.000000000      -0.000000000 )
          (      -0.000000000      13.578582391      -0.000000000 )
          (       0.000000000      -0.000000000      13.578582391 )
```
...
输出的dynmat.out中可以找到$\Gamma$点声子频率如下。
