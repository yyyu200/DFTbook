...
POSCAR格式与pw.x格式互相转换可以用[P2P工具](http://www.densityflow.com/p2p.php)。
...
使用[Unit2Prim](http://www.densityflow.com/unit2prim.php)转换为原胞，采用了[表格2](../../07/TransCell/#tab2)所述方法，可以实现所有类型（14种布拉伐格子中7种非简单格子，以及六方转菱方）的晶胞转原胞的功能，如果前面cif得到的已经是原胞或者属于简单格子，则输出结构相同。在Unit2Prim页面上传晶胞的pw.x输入文件，并指定Bravais格子类型，这里选择面心立方，即"2"，点击“提交”，得到原胞的输入文件。

[FindPrim](http://www.densityflow.com/findprim.php)采用了spglib提供的搜索原胞算法，对于晶胞甚至超胞都可以找到对应原胞。
